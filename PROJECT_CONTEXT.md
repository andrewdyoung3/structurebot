...
| Test count at generation | **628 collected / 609 passing / 19 skipped** (real run on merged `main`; 12 PyRosetta benchmark + 5 ColabFold accuracy-benchmark tests skip without their opt-ins/env; 2 opt-in live e2e tests skip too) |
