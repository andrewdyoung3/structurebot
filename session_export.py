...
_COLUMNS: Dict[str, List[str]] = {
    ...
    "stability_ddg": ["model", "design_chain", "variant", "resnum", "from_aa", "to_aa",
                      "ddg", "ddg_source", "rosetta_ddg", "thermompnn_ddg", "rasp_ddg",
                      "dynamut2_ddg", "combined_score", "recommendation", "sum_ddg", "tier"],
                ...
                if stab.get("rows"):
                    for r in stab["rows"]:
                        rows["stability_ddg"].append({
                            ...
                            "rosetta_ddg": r.get("rosetta_ddg"),
                            "thermompnn_ddg": r.get("thermompnn_ddg"),
                            "rasp_ddg": r.get("rasp_ddg"),
                            "dynamut2_ddg": r.get("dynamut2_ddg"),
